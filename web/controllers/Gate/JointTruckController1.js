                            ...
                            GateJointTruck.JointTruckBasic().isCanUpdate({
                                ...
                                voucherpromise.then(function(voucher){
                                    ...
                                    if($scope.userinfo.Company=='VH')
                                    {
                                        ...
                                        GateJointTruck.JointTruckBasic().JointTruckGetVHDetail({voucherid: $routeParams.code}).$promise.then(function (resDetails) {
                                            $scope.vouchergridOptions.columnDefs=vhCol;
                                            $scope.vouchergridOptions.data = resDetails;
                                        },function(error){
